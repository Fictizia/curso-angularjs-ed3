angular.module('app').service('list', ['$http', listService]);
  ...
  function listService($http){
    ...
    function get(stopId){
      ...
      //     stopTime.list = response.data.arrives;
      //   });


      $http.get('https://openbus.emtmadrid.es:9443/emt-proxy-server/last/bus/GetTimeTableLines.php')
      .then(function(data, status,headers,config){

         var object = data;
         stopTime.list = object.listArrives;
        //Succes
      ...
      // var listArrives = object.arrives;
      //   stopTime.list = listArrives;
