...
function arrivalTimeService($http) {
	...
	function get(stopId) {
		...
		$http.post('https://openbus.emtmadrid.es:9443/emt-proxy-server/last/geo/GetArriveStop.php',
		{
			IdCliente: 'WEB.SERV.emailEMTcliente',
			PassKey: 'EMT PassKey',
			idStop: 609, 
			cultureInfo: 'ES'
		})
